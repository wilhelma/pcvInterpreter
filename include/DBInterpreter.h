...
private:
	...
	ErrorCode processReturn(const instruction_t& ins);

	ErrorCode processInstruction(const instruction_t& instruction);
	ErrorCode processSegment(SEG_ID segmentId,
					   const segment_t& segment,
					   const instruction_t& instruction);
	ErrorCode processCall(CAL_ID callId,
					const call_t& call,
					const segment_t& segment,
					const instruction_t& instruction);
	...
	ErrorCode processMemAccess(ACC_ID accessId,
						 ...
						 const call_t& call,
						 const reference_t& reference);
	ErrorCode processAcqAccess(ACC_ID accessID,
						 const access_t& access,
						 const instruction_t& instruction,
						 const segment_t& segment,
						 const call_t& call,
						 const reference_t& reference);
	ErrorCode processRelAccess(ACC_ID accessID,
						 const access_t& access,
						 const instruction_t& instruction,
						 const segment_t& segment,
						 const call_t& call,
	...
	ErrorCode processFork(const instruction_t& instruction,
			const segment_t& segment,
			const call_t& call,
			const thread_t& thread);
